...
Work with a project structure, make a main.py module that imports functions from another Python module. After extracting the Wageningen Campus geometry, use this as a bounding box for extracting the buildings for this area.(hint .envelope, .exterior).
You can create these functions:

* geocodePlacenameToGeoDataFrame
* reproject
