...
```{r, eval=FALSE, engine='bash'}
conda create --name vectorpython python=3 geopandas spyder owslib kealib=1.4.7 jupyter -y
conda activate vectorpython
conda install --channel conda-forge folium matplotlib geopy osmnx -y
...
<img src="./images/buildingsGDF.png" alt="Buildings in Wageningen", width = "60%">
...
<img src="./images/campusParcelsGDF.png" alt="Parcels at Wageningen University Campus", width = "60%">
...
<img src="./images/wageningenFoliumMap.png" alt="Folium map of Wageningen University Campus", width = "100%">
...
<img src="./images/campusmap.png" alt="Road types at Wageningen University Campus", width = "100%">
...
Wageningen University is specifically interested in parcels with "perceelnummer": 
['10709', '10905', '10906', '10907', '10908', '10909', '11184', '11185', '11208', '11593']

Work with a project structure, make a main.py module that imports functions from another Python module. After downloading and selecting correct parcels, make a bounding box of the parcels to download water areas (hint .envelope, .exterior).
...
2. Calculate how much area (m2) is water for the campus.
3. Present a nice-looking map visualization of the campus, the relevant parcels and the water bodies within them.

Optional bonus: Calculate how much area (m2 and %) is water, <u>per parcel</u>. Present result nicely summarized in one table as also in a nice-looking map visualization of the relevant parcels and their (partial) coverage by water. 
