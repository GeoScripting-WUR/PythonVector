...
* Columnar formats, such as CSV or xls. Solution: Pandas can read [csv](https://pandas.pydata.org/pandas-docs/stable/generated/pandas.read_csv.html) or [excel](https://pandas.pydata.org/pandas-docs/stable/generated/pandas.read_excel.html) columns. The DataFrame with geometry columns can be converted to a GeoDataFrame.
...
2. Calculate how much area (m2 and %) is water, per parcel and for all parcels together. Present result nicely summarized in one table.
3. A nice-looking map visualization of the relevant parcels and (at least) the watered area.
