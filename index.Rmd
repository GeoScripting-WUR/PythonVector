...
Next, create a text file, (re)name it (to) `vector.yaml`, and copy the following content into the file:
```
name: vector
channels:
  - conda-forge
...
Use this file to create an environment for this tutorial, as you have learned in the previous lesson. Activate the environment, open Spyder, create a script in the `scripts` folder and start coding.
