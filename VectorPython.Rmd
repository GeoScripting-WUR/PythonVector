...
conda install --channel conda-forge folium geopy osmnx
```

Most of the installed software were Python packages. One was not. Can you tell which one? It was [Spyder](https://docs.spyder-ide.org/)! A simple yet powerful Python IDE. Let's start it up. Run some bash code below to setup your file system and start Spyder. When Spyder is started in a terminal with an active conda environment, Spyder automatically uses the Python interpreter of the active conda environment.
...
In Spyder you should see an editor, a file explorer and a console. Open a new file and save your Python script in the main directory you just made and name it main.py.
