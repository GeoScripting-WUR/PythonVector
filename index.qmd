...
author: "Jan Verbesselt, Jorge Mendes de Jesus, Aldo Bergsma, Dainius Masiliunas, David Swinkels, Judith Verstegen, Corné Vreugdenhil, Paolo Dal Lago"
date: today
engine: knitr
format:
  html:
...
![OGR class structure, source: Garrard, 2016, Geoprocessing with Python](./images/ogr_structure.png)
...
![](data/campusMap.html){width="100%" height="600px"}
